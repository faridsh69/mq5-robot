...
//+------------------------------------------------------------------+
//--- inputs for expert
input string         Expert_Title                  ="init2";     // Document name
ulong                Expert_MagicNumber            =25592;       //
...
//--- inputs for trailing
input int            Trailing_FixedPips_StopLevel  =1;           // Stop Loss trailing level (in points)
input int            Trailing_FixedPips_ProfitLevel=1;           // Take Profit trailing level (in points)
//--- inputs for money
