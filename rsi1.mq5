...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title         ="rsi1";      // Document name
ulong                    Expert_MagicNumber   =17971;       //
...
input double             Signal_PriceLevel    =30;         // Price level to execute a deal
input double             Signal_StopLevel     = - 3000;        // Stop Loss level (in points)
input double             Signal_TakeLevel     = - 3000;        // Take Profit level (in points)
...
input double             Signal_RSI_Weight    =0.3;         // Relative Strength Index(8,...) Weight [0...1.0]
//--- inputs for money
input double             Money_FixLot_Percent =30.0;        // Percent
input double             Money_FixLot_Lots    =0.03;         // Fixed volume
//+------------------------------------------------------------------+
