...
static input double Maximum_Amount  = 1; // Maximum position amount [lot]
static input double Adding_Amount   = 0.1; // Amount to add on addition [%]
static input double Reducing_Amount = 0.1; // Amount to close on reduction [%]
input int Stop_Loss   = 0; // Stop Loss [point]
input int Take_Profit = 2440; // Take Profit [point]
input int Break_Even  = 0; // Break Even [point]
static input double Martingale_Multiplier=0; // Martingale Multiplier

static input string IndicatorName1 = "RSI Convergence Divergence"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 73; // RSI Smoothing period
input int Slot1IndParam1 = 184; // Reference MA period
static input string IndicatorName3 = "Momentum MT"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 182; // Period
input int Slot3IndParam1 = 0; // Additional smoothing
input double Slot3IndParam2 = 111.51; // Level
...
static input int Bar_Close_Adv
ance=15; // Bar closing advance [sec]
...
class RSIConvergenceDivergence : public Indicator
  {
   double IsConvergence(double &ma1[],double &ma2[],int bar);
   double IsDivergence(double &ma1[],double &ma2[],int bar);
public:
   RSIConvergenceDivergence(SlotTypes slotType)
     {
      SlotType=slotType;
...
//|                                                                  |
//+------------------------------------------------------------------+
void RSIConvergenceDivergence::Calculate(DataSet &dataSet)
  {
   Data=GetPointer(dataSet);

// Reading the parameters
   BasePrice basePrice = (BasePrice)ListParam[2].Index;
   int referencePeriod=(int) NumParam[1].Value;
   int previous=CheckParam[0].Checked ? 1 : 0;

// Calculation

// ---------------------------------------------------------
   RSI *rsi=new RSI(SlotType);
   rsi.ListParam[1].Index = ListParam[1].Index;
   rsi.ListParam[2].Index = ListParam[2].Index;
   rsi.NumParam[0].Value = NumParam[0].Value;
   rsi.CheckParam[0].Checked=CheckParam[0].Checked;
   rsi.Calculate(dataSet);

   double indicatorMa[]; MovingAverage(referencePeriod,previous,MAMethod_Simple,rsi.Component[0].Value,indicatorMa);
   double adBasePrice[]; Price(basePrice,adBasePrice);
   double marketMa[]; MovingAverage(referencePeriod,previous,MAMethod_Simple,adBasePrice,marketMa);
// ----------------------------------------------------------

   int firstBar=rsi.Component[0].FirstBar+referencePeriod+2;
   double cd[]; ArrayResize(cd,Data.Bars); ArrayInitialize(cd,0);

   if(ListParam[0].Text=="Convergence")
      for(int bar= firstBar; bar<Data.Bars; bar++)
         cd[bar] = IsConvergence(indicatorMa,marketMa,bar);
   else if(ListParam[0].Text=="Divergence")
      for(int bar= firstBar; bar<Data.Bars; bar++)
...
// Saving the components
   ...
   Component[0].FirstBar = firstBar;
   ArrayResize(Component[0].Value,Data.Bars);
   ArrayCopy(Component[0].Value,rsi.Component[0].Value);
   delete rsi;

   Component[1].CompName = "RSI MA";
   Component[1].DataType = IndComponentType_IndicatorValue;
   Component[1].FirstBar = firstBar;
   ArrayResize(Component[1].Value,Data.Bars);
   ArrayCopy(Component[1].Value,indicatorMa);

   Component[2].FirstBar=firstBar;
   ArrayResize(Component[2].Value,Data.Bars);
   ArrayCopy(Component[2].Value,cd);

   Component[3].FirstBar=firstBar;
   ArrayResize(Component[3].Value,Data.Bars);
   ArrayCopy(Component[3].Value,cd);
...
//|                                                                  |
//+------------------------------------------------------------------+
double RSIConvergenceDivergence::IsConvergence(double &ma1[],double &ma2[],int bar)
  {
   double sigma=Sigma();
...
//|                                                                  |
//+------------------------------------------------------------------+
double RSIConvergenceDivergence::IsDivergence(double &ma1[],double &ma2[],int bar)
  {
   double sigma=Sigma();
   if(ma1[bar]>ma1[bar-1]+sigma && ma2[bar]<ma2[bar-1]-sigma)
      return (1);
...
Indicator *IndicatorManager::CreateIndicator(string indicatorName,SlotTypes slotType)
  {
   ...
   if (indicatorName == "RSI Convergence Divergence") return new RSIConvergenceDivergence(slotType);
if (indicatorName == "Momentum MT") return new MomentumMT(slotType);
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.FirstBar               = 262;
   strategy.MinBarsRequired        = 263;
   ...
   strategy.Slot[0].IndicatorName    = "Heiken Ashi";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Heiken Ashi", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long at the H.A. High";
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[1].Text    = "High, Low, Open, Close";
   ...
   strategy.Slot[1].IndicatorName    = "RSI Convergence Divergence";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("RSI Convergence Divergence", SlotTypes_OpenFilter);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "Convergence";
   strategy.Slot[1].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[1].IndicatorPointer.ListParam[1].Caption = "RSI smoothing method";
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[2].Index   = 6;
   strategy.Slot[1].IndicatorPointer.ListParam[2].Text    = "Weighted";

   strategy.Slot[1].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[1].IndicatorPointer.NumParam[0].Caption = "RSI Smoothing period";
   strategy.Slot[1].IndicatorPointer.NumParam[0].Value   = Slot1IndParam0;
   strategy.Slot[1].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[1].IndicatorPointer.NumParam[1].Caption = "Reference MA period";
   ...
   strategy.Slot[3].IndicatorName    = "Momentum MT";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Momentum MT", SlotTypes_CloseFilter);

   strategy.Slot[3].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[3].IndicatorPointer.ListParam[0].Index   = 2;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Momentum is higher than the Level line";
   ...
   strategy.Slot[3].IndicatorPointer.NumParam[1].Caption = "Additional smoothing";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName></programName><programVersion></programVersion><strategyName>BTCUSDM15-I1000-L30-20%-59635-99</strategyName><profileName>bitcoin</profileName><dataSourceName>Bitcoin</dataSourceName><instrumentSymbol>BTCUSD</instrumentSymbol><instrumentPeriod>15</instrumentPeriod><sameDirSignalAction>Nothing</sameDirSignalAction><oppDirSignalAction>Nothing</oppDirSignalAction><maxOpenLots>1</maxOpenLots><useAccountPercentEntry>True</useAccountPercentEntry><entryLots>20</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description></description><recommendedBars>1000</recommendedBars><openFilters>1</openFilters><closeFilters>1</closeFilters><firstBar>262</firstBar><minBarsRequired>263</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">1000</permanentStopLoss><permanentTakeProfit usePermanentTP=\"True\" permanentTPType=\"Relative\">2440</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Heiken Ashi</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter long at the H.A. High</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>High, Low, Open, Close</value></listParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>RSI Convergence Divergence</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Convergence</value></listParam><listParam paramNumber=\"1\"><caption>RSI smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>6</index><value>Weighted</value></listParam><numParam paramNumber=\"0\"><caption>RSI Smoothing period</caption><value>73</value></numParam><numParam paramNumber=\"1\"><caption>Reference MA period</caption><value>184</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"Close\"><indicatorName>Day Closing</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit the market at the end of the day</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Close</value></listParam></slot><slot slotNumber=\"3\" slotType=\"CloseFilter\" logicalGroup=\"a\"><indicatorName>Momentum MT</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>2</index><value>Momentum is higher than the Level line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>182</value></numParam><numParam paramNumber=\"1\"><caption>Additional smoothing</caption><value>0</value></numParam><numParam paramNumber=\"2\"><caption>Level</caption><value>111.51</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot></strategy> */
//+------------------------------------------------------------------+
